...
import { ToggleActiveSchema } from "@/lib/validation/network"; // gunakan schema boolean yang sama
...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const updated = await app.paymentOption.service.toggleActive(id, parsed.data.isActive);
